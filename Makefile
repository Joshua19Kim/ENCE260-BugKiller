...
game.out: game.o gameboard.o scrollstring.o pio.o system.o timer.o display.o ledmat.o font.o pacer.o tinygl.o navswitch.o transmitter.o ir_uart.o timer0.o usart1.o prescale.o
	$(CC) $(CFLAGS) $^ -o $@ -lm
	$(SIZE) $@
